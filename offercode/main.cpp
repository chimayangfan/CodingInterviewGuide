...
//	}
//	bool inflag = true, outflag = true;
//	int divt1 = 0, remat1 = 0, divt2 = 0, remat2 = 0;
//	for (int i = 0; i < n; ++i) {
//		divt1 = t[i] / t1[i];
//		remat1 = t[i] % t1[i];
//		divt2 = t[i] / t2[i];
...
//		int in = 0, out = 0;
//		if (divt1 % 2) {
//			in = (divt1 / 2 + 1)*m1[i] * t1[i];
//		}
//		else {
//			in = (divt1 / 2)*m1[i] * t1[i] + remat1*m1[i];
//		}
//		if (divt2 % 2) {
//			out = (divt2 / 2 + 1)*m2[i] * t2[i];
//		}
//		else {
//			out = (divt2 / 2)*m2[i] * t2[i] + remat2*m2[i];
//		}
//		if ((in - out) < 0) {
//			cout << 0 << endl;
//			continue;
...
int main() {
	...
	vector<int> flood{15,24,19,1,17,24};
	//cin >> n;
...
vector<long long> CinIntVector(int n) {
...
int main() {
	int n, m;
	cin >> n;
	vector<long long> arr = CinIntVector(n);
	cin >> m;
	vector<long long> flood = CinIntVector(m);
